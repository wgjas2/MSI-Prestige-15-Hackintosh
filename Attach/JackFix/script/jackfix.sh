...
###
### These are pins for the MSI Prestige 15 ALC298 with
### ALC layout 3.
###

${IPATH}/hda-verb 0x12 SET_PIN_WIDGET_CONTROL 0x24
${IPATH}/hda-verb 0x14 SET_PIN_WIDGET_CONTROL 0x24
${IPATH}/hda-verb 0x18 SET_PIN_WIDGET_CONTROL 0x24
${IPATH}/hda-verb 0x21 SET_PIN_WIDGET_CONTROL 0x24
